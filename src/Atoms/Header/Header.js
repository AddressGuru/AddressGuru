...
<div className="lg:grid lg:grid-cols-12 grid grid-cols-5 gap-4 lg:px-10 px-3 py-3 border-b-2 ">
<div className="lg:pt-3">
<SideNav/>
</div>
<div className="col-span-2 px-2 float-right">
<img src={logo} className="w-6/7"/>
</div>
...
<div className="border-2 border-gray-400 p-2 lg:flex lg:justify-center rounded-3xl  pr-1">
 ...
 <i className="fa fa-map-marker fa-fw"></i> {city}
  ...
  <Dropdown.Menu>
    {data.sort().map((items,i)=>(
        ...
        <input type={`text`} placeholder={`Search `} className=" w-4/5 lg:w-3/5 lg:border-l-2 pl-2 top-0 bg-gray-100 relative focus:border-0" />
        <button className=" lg:w-1/5 float-right -top-1 relative   "> <i class="fa fa-search float-right bg-purple-800 p-2 rounded-2xl text-white "></i></button>
</div>
</div>
