                                ...
                                <div className="col-span-8 lg:col-span-3 py-2 ml-4">
                                        <div className="grid grid-cols-4">
                                                <div className="lg:col-span-3 col-span-4 lg:border-r-2 lg:pr-2">
                                                        <h4 className=" font-bold lg:text-xl lg:mb-3 mb-1 lg:font-normal text-blue-700">Four Color Print Solution | Printing Service in Dehradun</h4>
                                                        ...
                                                        <div className="lg:hidden block">
                                                                ...
                                                                <div className="grid grid-cols-12">
                                                                        <div className="col-span-4"><button className=" w-full py-1 rounded-sm text-black border-1 border-orange-600 text-xs bg-white">Call Now</button></div>
                                                                        <div className="px-2 col-span-5"><Link to="/third"><button className="w-full py-1 rounded-sm text-white border-1 border-blue-600 text-xs bg-blue-600">View Details</button></Link></div>
                                                                </div>
                                                        </div>
                                                </div>
