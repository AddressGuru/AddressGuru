...
const ListingCards = (props) => {
        ...
        return (
                <>
                        ...
                        <div className="grid grid-cols-9 -mb-3 border-2 border-gray-200 rounded-xl hover:shadow-2xl hover:scale-105">
                                <div className="col-span-2 px-2 py-1">
                                        <img src={props.image1} className="border-2 shadow-xl border-gray-100 rounded-lg h-full" />
                                </div>
