...
const Trusted = () => {
        ...
        return (
              <div className="lg:px-16 xl:px-48 sm:px-8 bg-gray-200 lg:py-20 py-8 ">
              <h1 className="text-center lg:text-4xl text-2xl lg:mb-16 mb-8 md:px-2"><b className="text-blue-500">Trusted By 1,000 Web Hosts For</b> Domains & Hosting</h1>
                       <div className="lg:grid lg:grid-cols-3 md:grid md:grid-cols-3 grid grid-cols-1 gap-8 sidePadding sm:px-10">
